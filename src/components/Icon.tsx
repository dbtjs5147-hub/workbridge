...
// 외부 라이브러리 없이 사용하는 선(line) 스타일 아이콘 세트.
// <Icon name="search" className="h-5 w-5" /> 형태로 사용. 색은 currentColor를 따른다.
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  "star-filled": (
    <path
      d="m12 3 2.7 5.5 6 .9-4.3 4.2 1 6L12 17l-5.4 2.6 1-6L3.3 9.4l6-.9z"
      fill="currentColor"
      stroke="none"
    />
  ),
  ...
  users: (
    <>
      ...
      <path d="M16 4.2A4 4 0 0 1 16 12" />
    </>
  ),
  user: (
    <>
